    ...
    contributionList: [
      {
        ...
        descriptions: [
          ...
          "디자인팀과 지속적이고 적극적인 소통 기반 협업을 통해 완성도 높은 UX/UI 결과물 구현, 광고주로부터 결과물에 대해 긍정적인 피드백을 받음",
        ],
      },
      {
        ...
        descriptions: [
          ...
          "서비스 베타버전의 <b>10여개의 버그 수정 및 인터랙션 개선</b>을 통해 서비스 정식 버전 출시에 기여",
          "회원가입 유입 경로 추적 및 일별 가입/탈퇴 통계를 시각화된 차트로 제공하는 기능 개발",
          "해당 통계 기능이 사내 마케팅 전략에 반영되어 <b>주간 가입자 수 약 92% 증가(주간 평균 13명 → 25명)</b>에 기여",
          "`img` 태그를 Next.js의 `Image` 컴포넌트로 전면 마이그레이션 및 Lazy Loading 도입을 통해 <b>Lighthouse 기준 초기 로드 성능 79점 → 85점으로 개선</b>",
          "인스타그램 4:5 업로드 규격에 맞춰 <b>이미지 비율 전면 개편</b> 및 <b>팝업스토어 별 좋아요 수·조회수 노출되도록</b> 개선, 이후 <b>GA 기준 플랫폼 평균 체류 시간 약 50% 증가 (20초 → 30초)</b>",
        ],
      },
      {
        ...
        descriptions: [
          ...
          "사내 배포 이후 마케팅팀 내 일 평균 <b>20~30회 이상 사용되며 실제 마케팅 전략 수립에 해당 플랫폼 활용</b>",
        ],
      },
      {
        ...
        descriptions: [
          ...
          "모바일 및 PC 환경에 대응하는 반응형 퍼블리싱으로 기기별 일관된 사용자 경험 제공",
        ],
      },
    ],
  },
